...
public class PetIdDelete extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String parameter = request.getParameter("petidDelete");
		logger.info(" Inside delete servlet .");
		...
		if (loginUserDetails != null && loginUserDetails.isLogin()) {
			...
			detailsDao.deletePetDeails(petDetails, mongoDatabase,mongoClient);
