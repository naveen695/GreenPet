    ...
    dataRequestObject= {id:locations};
	 	 $.ajax({
	         ...
	         success : function(responseText) {
	        	...
	        	document.getElementById("imageID").value=responseText.imageID;
	        	document.getElementById("petID").value=responseText.petID;
	         },
		     beforeSend: function(){
		        	 $(".modal1").show();
			 },
